defmodule RemoteDockers.HostConfigTest do
  ...
  test "custom hostname and port and SSL configuration" do
    assert HostConfig.build("192.168.99.100", 2345, "cert.pem", "key.pem")
