defmodule RemoteDockers.ImageTest do
  ...
  test "fail listing images" do
    assert_raise(ArgumentError, "Invalid HostConfig type", fn -> Image.list!("host_config") end)
  end
  ...
  test "fail listing all images" do
    assert_raise(ArgumentError, "Invalid HostConfig type", fn -> Image.list_all!("host_config") end)
  end
  ...
  test "fail pulling an images" do
    assert_raise(ArgumentError, "Invalid HostConfig type", fn -> Image.pull!("host_config", "hello-world") end)
  end
